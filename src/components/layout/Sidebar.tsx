  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '0.875rem 1.25rem', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div id="sidebar-studio" style={{ color: 'white', fontSize: 13, fontWeight: 500 }}>{studioNome}</div>
      </div>
      ...
      <div style={{ padding: '0.875rem 1.25rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
        <div id="sidebar-email" style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, marginBottom: 8 }}>{utenteEmail}</div>
